...
logger_filename = 'logs/simply_random_negative/only_embedding.log'
save_path = 'model_weights/simply_random_negative/only_embedding.pth'
...
class BiModel(nn.Module):
    ...
    def classify_pair(self,emb1_1,emb1_2,emb2_1,emb2_2):
        ...
        x = torch.cat([x1_1, x1_2, torch.abs(x1_diff)], dim=1)  # 差别 以及差别的绝对值
        x = self.linear2(x)
        return x
